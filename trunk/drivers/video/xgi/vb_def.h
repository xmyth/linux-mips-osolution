...
#ifndef WIN2000 /*[Billy]07/11/15 Only for Non WIN2000*/
#define I2C_CRT         0
#define I2C_DVI         1
#define I2C_FCNT        2
#define I2C_OPEN        1
...
#define DVI_I2C_Index            0x0F

#define VB_PART4_OFFSET_14         0x14 - 0x30
...
#define GETBITS(b,n)    ( ((b) & MASK(n)) >> SMALL(n) )
...
/* Note: Above macros can not accept m or n=63:0 within 64-bit CPU register */
/* Note: Above macros can not accept m or n=31:0 within 32-bit CPU register */
/* Note: Above macros can not accept m or n=15:0 within 16-bit CPU register */
/* Note: Above macros can not accept m or n= 7:0 within  8-bit CPU register */
